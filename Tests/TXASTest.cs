...
public class TXASTest {
    ...
    public void createCommand2() {
        string actual = TXAS.createCommand(["Command", "Security", "Certificates", "Services", "Add"], new Dictionary<string, string> {
            { "Fingerprint", "abc" },
    ...
    public void xmlTest() {
        ...
        Assert.Equal(2, actual.certificates.Count);
        Assert.Equal("ce4eb947c2c17d58bbc08303bf278464beebf2af", actual.certificates[0].fingerprint);
    }
